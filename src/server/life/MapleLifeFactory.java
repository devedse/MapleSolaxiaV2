...
public class MapleLifeFactory {
    ...
    private static MapleMonsterStats getStats(int mid) {
    ...
    public static MapleMonster getBossBattleMonster(int mid) {
        MapleMonsterStats stats = getStats(mid);
        stats.setExp(0);
        MapleMonster bossBattleMonster = getMonster(mid, stats);
        bossBattleMonster.disableDrops();
        bossBattleMonster.setIsBossBattleMonster(true);
        return bossBattleMonster;
    }

    public static MapleMonster getMonster(int mid) {
        MapleMonsterStats stats = monsterStats.get(Integer.valueOf(mid));
        return getMonster(mid, stats);
    }

    public static MapleMonster getMonster(int mid, MapleMonsterStats stats) {
        try {
            if (stats == null) {
                stats = getStats(mid);
